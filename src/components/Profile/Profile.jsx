...
const Profile = () => {
    ...
    return (
      ...
      <button
          className={`collapse-button ${isCollapsed ? 'collapsed-button' : ''}`}
          onClick={toggleCollapse}
          title={isCollapsed ? "Expand Profile Tab" : "Collapse Profile Tab"}
      >
          {isCollapsed ? '➡️' : '⬅️'}
      </button>
      {!isCollapsed && (
          <div className="user-profile">
              ...
              <div className="study-session">
                  <div className="section-title">RECENT STUDY SESSION</div>
                  <div className="level-progress">
                      <div className="level-label">Biology</div>
                      <div className="progress-bar">
                          <div className="recentStudyProgress" style={{ width: '80%' }}></div>
                      </div>
                      <img src="src/assets/hourglass.png" className="icon" alt="" />
                  </div>
                  <button className="challenge-button">Send Challenge Request...</button>
              </div>
          </div>
      )}
  </div>
